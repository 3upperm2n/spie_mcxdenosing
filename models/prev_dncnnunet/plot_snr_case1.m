...
load('../../prepare_data/spie2d_customize/test_snr_case1/1e+07/test1.mat');
...
load('../../prepare_data/spie2d_customize/test_snr_case1/1e+08/test1.mat');
...
%% model
load('./test_snr_case1.mat');  % 3d array: sample x 2d images
