...
parser.add_argument(
    ...
    default=32, # Note, I use the same batch size when generating input.
...
def denoiser_train(denoiser, lr):
    ...
    #  heterogenous 2d images: 
    #   To generate rand2d() heteregeneous data:  prepare_data/rand2d
    #  the original data is located at : data/rand2d/1e+07

    noisy_data = np.load('../../model_input/rand2d/rand2d_noisy_pats_1e+07.npy')
    clean_data = np.load('../../model_input/rand2d/rand2d_clean_pats_1e+07.npy')
